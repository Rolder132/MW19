...
public class DesktopLauncher implements Runnable {
    ...
    //
    @Option(names = { "-b", "--boards"},
    		description = "Game starts with specified Map in the planning phase. ")
    boolean map;
    // int x = 0, for x < 5 --> 1.map, 2.map, 3.map,...
    
  /*  public void chose() {
    	GameScreen.drawPlayingField(boards);
    }*/
    //
    /**
